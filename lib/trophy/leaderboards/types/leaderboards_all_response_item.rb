...
module Trophy
  module Leaderboards
    module Types
      class LeaderboardsAllResponseItem < Internal::Types::Model
        ...
        field :status, -> { Trophy::Leaderboards::Types::LeaderboardsAllResponseItemStatus }, optional: false, nullable: false
      end
    end
  end
end
