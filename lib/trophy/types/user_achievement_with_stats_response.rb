...
module Trophy
  module Types
    class UserAchievementWithStatsResponse < Internal::Types::Model
      field :completions, -> { Integer }, optional: false, nullable: false

      field :rarity, -> { Integer }, optional: false, nullable: false
