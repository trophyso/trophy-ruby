...
module Trophy
  module Types
    # Response containing deleted achievements represented by ID and any per-item issues, including invalid or missing
    # achievement IDs.
    class DeleteAchievementsResponse < Internal::Types::Model
