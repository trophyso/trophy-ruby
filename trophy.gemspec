...
require_relative "lib/trophy/version"
...
Gem::Specification.new do |spec|
  spec.name = "trophy"
  spec.authors = ["Trophy"]
  spec.version = Trophy::VERSION
  spec.summary = "Ruby client library for the Trophy API"
  spec.description = "The Trophy Ruby library provides convenient access to the Trophy API from Ruby."
