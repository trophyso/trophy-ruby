...
describe Trophy::Internal::Types::Model do
  ...
  class ExampleModel < Trophy::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Trophy::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Trophy::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Trophy::Internal::Types::Model
