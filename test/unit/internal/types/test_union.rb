...
describe Trophy::Internal::Types::Union do
  class Rectangle < Trophy::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Trophy::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Trophy::Internal::Types::Model
