...
describe Trophy::Internal::Types::Utils do
  Utils = Trophy::Internal::Types::Utils

  module TestUtils
    class M < Trophy::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Trophy::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Trophy::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Trophy::Internal::Types::Union
    ...
    SymbolStringHash = Trophy::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Trophy::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Trophy::Internal::Types::Array[String]
      ModelArray = -> { Trophy::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Trophy::Internal::Types::Array[TestUtils::U] }
